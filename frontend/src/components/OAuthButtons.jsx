...
function GoogleIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <path fill="#34A853" d="M3.6 7.4l3 2.2C7.5 7.5 9.6 6.2 12 6.2c1.8 0 3 .7 3.7 1.4l2.5-2.4C16.8 3.7 14.6 2.7 12 2.7 8.3 2.7 5.1 4.8 3.6 7.4z" />
      <path fill="#4A90E2" d="M12 21.3c2.5 0 4.6-.8 6.1-2.2l-2.9-2.2c-.8.6-1.9 1-3.2 1-3.5 0-6.5-2.4-7.5-5.6l-3 2.3C3.1 18.9 7.2 21.3 12 21.3z" />
      <path fill="#FBBC05" d="M4.5 12c0-.8.1-1.5.4-2.2l-3-2.3C1.3 9 1 10.5 1 12s.3 3 1 4.5l3-2.3c-.3-.7-.5-1.4-.5-2.2z" />
    </svg>
  );
}
